    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <main className="flex-grow">
          <div className="flex flex-col gap-12 py-12 px-4 md:px-8 max-w-5xl mx-auto bg-gradient-to-br from-blue-50 via-white to-pink-50 rounded-3xl shadow-xl">
            {/* --- qui va il contenuto home originale --- */}
            <motion.div
